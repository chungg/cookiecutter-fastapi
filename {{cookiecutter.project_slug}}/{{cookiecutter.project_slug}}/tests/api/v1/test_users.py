...
from {{cookiecutter.project_slug}}.schemas.user import UserCreate
from {{cookiecutter.project_slug}}.tests.utils.user import random_email, random_lower_string, TEST_SUPERUSER, TEST_USER
...
def test_get_users_superuser_me(
    ...
    assert current_user["email"] == TEST_SUPERUSER
...
def test_get_users_normal_user_me(
    ...
    assert current_user["email"] == TEST_USER
